...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'manageRoles.childLinkingTitle': 'Link Ministered Accounts',
    'manageRoles.childLinkingDesc': 'Link user accounts (with Ministered role) to records so they can access their dashboard',
    'manageRoles.childRecord': 'Ministered Record',
    'manageRoles.linkedAccount': 'Linked Account',
    'manageRoles.selectChildUser': 'Select a Ministered user...',
    ...
    'auditLog.adminOnly': 'Only administrators can access the audit log',
    'auditLog.loadError': 'Failed to load audit logs',
    'auditLog.searchPlaceholder': 'Search by user or record...',
    'auditLog.filterTable': 'Filter by table',
    'auditLog.filterAction': 'Filter by action',
    'auditLog.allTables': 'All Tables',
    'auditLog.allActions': 'All Actions',
    'auditLog.tableChildren': 'Children',
    'auditLog.tableAttendance': 'Attendance',
    'auditLog.tableRoles': 'User Roles',
    ...
    'parentPortal.parentOnly': 'Only parents can access this portal',
    'parentPortal.loadError': 'Failed to load data',
    'parentPortal.myChildren': 'My Children',
    'parentPortal.excuses': 'Excuses',
    'parentPortal.messages': 'Messages',
    'parentPortal.points': 'Points',
    'parentPortal.noChildren': 'No children linked to your account',
    'parentPortal.recentAttendance': 'Recent Attendance',
    'parentPortal.submitExcuse': 'Submit Excuse',
    'parentPortal.selectChild': 'Select child',
    'parentPortal.excuseReasonPlaceholder': 'Enter the reason for absence...',
    'parentPortal.excuseSubmitted': 'Excuse submitted successfully',
    'parentPortal.excuseError': 'Failed to submit excuse',
    'parentPortal.noExcuses': 'No excuses submitted yet',
    'parentPortal.statusPending': 'Pending',
    'parentPortal.statusApproved': 'Approved',
    'parentPortal.statusRejected': 'Rejected',
    // Absence Excuses (staff view)
    'excuses.title': 'Absence Excuses',
    'excuses.loadError': 'Failed to load excuses',
    'excuses.noExcuses': 'No absence excuses found',
    'excuses.submittedBy': 'Submitted by',
    'excuses.serviceDate': 'Service Date',
    'excuses.approve': 'Approve',
    'excuses.reject': 'Reject',
    'excuses.statusUpdated': 'Status updated successfully',
    'excuses.updateError': 'Failed to update status',
    'excuses.all': 'All',
    'parentPortal.sendMessage': 'Send Message',
    'parentPortal.selectServant': 'Select servant',
    'parentPortal.regardingChild': 'Regarding child (optional)',
    'parentPortal.subject': 'Subject',
    'parentPortal.messagePlaceholder': 'Write your message...',
    'parentPortal.send': 'Send',
    'parentPortal.messageSent': 'Message sent successfully',
    'parentPortal.messageError': 'Failed to send message',
    'parentPortal.noMessages': 'No messages yet',
    'parentPortal.newMessage': 'You have a new message',
    'parentPortal.sent': 'Sent',
    'parentPortal.received': 'Received',
    'parentPortal.unread': 'New',
  ...
  ar: {
    ...
    'manageRoles.childLinkingTitle': 'ربط حسابات المخدومين',
    'manageRoles.childLinkingDesc': 'ربط حسابات المستخدمين (بدور مخدوم) بسجلات المخدومين حتى يتمكنوا من الوصول إلى لوحة التحكم الخاصة بهم',
    'manageRoles.childRecord': 'سجل المخدوم',
    'manageRoles.linkedAccount': 'الحساب المرتبط',
    'manageRoles.selectChildUser': 'اختر مستخدم مخدوم...',
    ...
    'auditLog.adminOnly': 'فقط المسؤولون يمكنهم الوصول لسجل المراجعة',
    'auditLog.loadError': 'فشل في تحميل سجل المراجعة',
    'auditLog.searchPlaceholder': 'البحث بالمستخدم أو السجل...',
    'auditLog.filterTable': 'تصفية حسب الجدول',
    'auditLog.filterAction': 'تصفية حسب الإجراء',
    'auditLog.allTables': 'جميع الجداول',
    'auditLog.allActions': 'جميع الإجراءات',
    'auditLog.tableChildren': 'الأطفال',
    'auditLog.tableAttendance': 'الحضور',
    'auditLog.tableRoles': 'أدوار المستخدمين',
    'auditLog.actionCreate': 'إنشاء',
    'auditLog.actionUpdate': 'تحديث',
    'auditLog.actionDelete': 'حذف',

    // Parent Portal
    'parentPortal.title': 'بوابة ولي الأمر',
    'parentPortal.parentOnly': 'فقط أولياء الأمور يمكنهم الوصول لهذه البوابة',
    'parentPortal.loadError': 'فشل في تحميل البيانات',
    'parentPortal.myChildren': 'أطفالي',
    'parentPortal.excuses': 'الأعذار',
    'parentPortal.messages': 'الرسائل',
    'parentPortal.points': 'النقاط',
    'parentPortal.noChildren': 'لا يوجد أطفال مرتبطين بحسابك',
    'parentPortal.recentAttendance': 'الحضور الأخير',
    'parentPortal.submitExcuse': 'تقديم عذر',
    'parentPortal.selectChild': 'اختر الطفل',
    'parentPortal.excuseReasonPlaceholder': 'أدخل سبب الغياب...',
    'parentPortal.excuseSubmitted': 'تم تقديم العذر بنجاح',
    'parentPortal.excuseError': 'فشل في تقديم العذر',
    'parentPortal.noExcuses': 'لم يتم تقديم أعذار بعد',
    'parentPortal.statusPending': 'قيد الانتظار',
    'parentPortal.statusApproved': 'مقبول',
    'parentPortal.statusRejected': 'مرفوض',
    'excuses.title': 'أعذار الغياب',
    'excuses.loadError': 'فشل في تحميل الأعذار',
    'excuses.noExcuses': 'لا توجد أعذار غياب',
    'excuses.submittedBy': 'مقدم من',
    'excuses.serviceDate': 'تاريخ الخدمة',
    'excuses.approve': 'قبول',
    'excuses.reject': 'رفض',
    'excuses.statusUpdated': 'تم تحديث الحالة بنجاح',
    'excuses.updateError': 'فشل في تحديث الحالة',
    'excuses.all': 'الكل',
    'parentPortal.sendMessage': 'إرسال رسالة',
    'parentPortal.selectServant': 'اختر الخادم',
    'parentPortal.regardingChild': 'بخصوص طفل (اختياري)',
    'parentPortal.subject': 'الموضوع',
    'parentPortal.messagePlaceholder': 'اكتب رسالتك...',
    'parentPortal.send': 'إرسال',
    'parentPortal.messageSent': 'تم إرسال الرسالة بنجاح',
    'parentPortal.messageError': 'فشل في إرسال الرسالة',
    'parentPortal.noMessages': 'لا توجد رسائل بعد',
    'parentPortal.newMessage': 'لديك رسالة جديدة',
    'parentPortal.sent': 'مرسل',
    'parentPortal.received': 'مستلم',
    'parentPortal.unread': 'جديد',
    ...
    'parentPortal.unknownUser': 'مستخدم غير معروف',
    'parentPortal.selectConversation': 'اختر محادثة لبدء الدردشة',
